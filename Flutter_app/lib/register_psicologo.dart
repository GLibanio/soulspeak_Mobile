...
import 'login_psicologo.dart';

class RegisterPsicologoScreen extends StatefulWidget {
  @override
  _RegisterPsicologoScreenState createState() => _RegisterPsicologoScreenState();
}

class _RegisterPsicologoScreenState extends State<RegisterPsicologoScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      if (userCredential.user != null) {
        await _firestore.collection('psicologos').doc(userCredential.user!.uid).set({
            ...
            onPressed: () {
              ...
              if (success) {
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(builder: (context) => LoginPsicologoScreen()),
                );
              }
            },
            child: Text("OK"),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            Text("PSICÓLOGO", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.white)),
            SizedBox(height: 20),
            _buildInputRow("Nome:", firstNameController, "Primeiro Nome", lastNameController, "Sobrenome"),
            _buildInputField("CRP Ativo:", crpController, "Exemplo: 01/23456"),
            _buildBirthDateInput(),
            _buildInputField("E-mail:", emailController, "exemplo@email.com"),
